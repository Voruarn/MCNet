...
from network.MCNetTR3 import MCNet3, CLIPTextEncoder
...
parser.add_argument("--dataset", type=str, default='SOD3K', 
                    help='Name of dataset:[RGBDSOD]')
parser.add_argument('--model', type=str, default='MCNet3', 
                    help='model name:[MCNet]')
...
parser.add_argument('--save_path', type=str, default='./CHKP3/', help='checkpoint save path')
...
if __name__=='__main__':
    ...
    print(f"[Model] Loaded model with backbone: {opt.convnext_model}")
